...
namespace Website.Areas.Admin.Controllers
{
    ...
    public class AdvController : Controller
    {
        ...
        public IActionResult Read(int? page)
        {
            ...
            List<Adv> _ListRecord = db.Advs.OrderByDescending(item => item.Id).ToList();
        ...
        public IActionResult update(int? id)
        {
            int _id = id ?? 0;
            //lay mot ban ghi
            Adv record = db.Advs.Where(item => item.Id == _id).FirstOrDefault();
        ...
        public IActionResult Update(IFormCollection fc, int? id)
        {
            ...
            var record = db.Advs.Where(item => item.Id == _id).FirstOrDefault();
            //update ban ghi
            record.Name = _Name;
